  ...
  return (
    <div className="flex flex-col items-center justify-center p-6">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3 bg-white shadow-md rounded-lg p-6 w-80">
        <input type="text" name="cn" ref={inputRef} placeholder="Try typing your name here..." className="border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"/>
